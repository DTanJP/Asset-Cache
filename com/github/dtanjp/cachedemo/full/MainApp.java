...
/**
 * MainApp.java
 * Description: Demonstrates loading files + extracting using the full cache class
 * 
 * @author David Tan
 **/
		...
		if(cache.exist()) {
			...
			if(cache.get("dog.png") != null) {
				try {
						...
						//Extract the dog image out of the cache
						cache.extract("", "dog.png");
				} catch (IOException e) {
					e.printStackTrace();
